...
/**
 * Rectangular spin button for mobile 16:9 landscape.
 * Same icon and outline as original, but rounded rect shape.
 */
export class MobileSpinButtonView extends ButtonView {
    private background!: Graphics;
    private iconSprite!: Sprite;
    private _isAutoMode = false;
    private _isSkipMode = false;
