...
class GameModelClass {
    ...
    private _pendingBonusBalance = -1;
    ...
    get pendingBonusBalance(): number { return this._pendingBonusBalance; }
    ...
    setPendingBonusBalance(value: number): void {
        this._pendingBonusBalance = value;
    }
}
